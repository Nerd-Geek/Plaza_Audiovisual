...
INSERT INTO `users`(`id`, `username`, `name`, `lastname`,`email`,`phone_number`, `password`,
                    `image`, `description`) VALUES
                                                ('49c32c1e-bdc0-4999-94b4-46b9e724ac25', 'manolo23', 'Manolo', 'Sánchez', 'manolo@sanchez.com',
                                                 '123456788', '$2a$10$Qar.LEjvMxWFsdgCQuQVU.5Eto7JqBzg3YEC94Dd6lOaNGlLirRtu', 'http://carlosmoreno.duckdns.org:9090/rest/files/1666536614758_avatar.png', 'algo'),
                                                ('f24183eb-bd3d-4a98-af56-9c2409a5f87c', 'pepo321', 'Pepo', 'Pepito', 'pepo@pepito.com',
                                                 '123456789', '$2a$10$Qar.LEjvMxWFsdgCQuQVU.5Eto7JqBzg3YEC94Dd6lOaNGlLirRtu', 'http://carlosmoreno.duckdns.org:9090/rest/files/1666536760224_avatar2.png', 'algo'),
                                                ('5a1ee629-81ce-4922-af8f-e4dd8dfd2cff', 'paco30', 'Paco', 'Sánchez', 'paco@sanchez.com',
                                                 '123456787', '$2a$10$Qar.LEjvMxWFsdgCQuQVU.5Eto7JqBzg3YEC94Dd6lOaNGlLirRtu', 'http://carlosmoreno.duckdns.org:9090/rest/files/1666536874687_avatar3.png', 'algo');
...
INSERT INTO `media` (`id`, `size`, `type`, `name`, `description`, `dimension`,`user_id`) VALUES
                                                                                             ('6a3831f9-d026-4764-9b46-44d1427f07e5', 12.5, 'png', 'http://carlosmoreno.duckdns.org:9090/rest/files/1666513107101_gato.jpg', 'Foto', 1920,'49c32c1e-bdc0-4999-94b4-46b9e724ac25'),
                                                                                             ('dca76e7e-6dc5-4ad0-81a6-254f3c7b3b84', 12.5, 'png', 'http://carlosmoreno.duckdns.org:9090/rest/files/1666513117352_playa.jpg', 'Foto', 1920,'f24183eb-bd3d-4a98-af56-9c2409a5f87c'),
                                                                                             ('bb552132-f830-410f-813b-fc777129492e', 12.5, 'png', 'http://carlosmoreno.duckdns.org:9090/rest/files/1666513129289_puente.jpg', 'Foto', 1920,'5a1ee629-81ce-4922-af8f-e4dd8dfd2cff');